    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-white/95 dark:bg-zinc-900/95 backdrop-blur-2xl border border-zinc-200 dark:border-zinc-800/60 rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/50 overflow-hidden">
              {/* Header */}
              <div className="p-5 border-b border-zinc-200 dark:border-zinc-800/60 flex items-center justify-between">
                <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">Audio Settings</h2>
                <button
                  onClick={onClose}
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    {audioInputs.length === 0 && (
                      <p className="text-sm text-zinc-500 dark:text-zinc-600 py-2">No microphones found</p>
                    )}
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          selectedInput === device.deviceId
                            ...
                            : "bg-zinc-50 dark:bg-zinc-900/60 text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-800/40 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 hover:text-zinc-900 dark:hover:text-zinc-300"
                        )}
                      >
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    {audioOutputs.length === 0 && (
                      <p className="text-sm text-zinc-500 dark:text-zinc-600 py-2">No output devices found</p>
                    )}
                    {audioOutputs.map((device) => (
                      <div
                        key={device.deviceId}
                        className="w-full text-left px-4 py-3 rounded-xl text-sm bg-zinc-50 dark:bg-zinc-900/60 text-zinc-500 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-800/40"
                      >
              ...
              {/* Footer */}
              <div className="p-5 border-t border-zinc-200 dark:border-zinc-800/60">
                <Button
                  onClick={onClose}
                  className="w-full bg-zinc-100 hover:bg-zinc-200 text-zinc-900 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-200"
                >
                  Done
                </Button>
              </div>
